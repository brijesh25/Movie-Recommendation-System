...
#Remove all english stop words such as 'the', 'a' etc because they comes many times and we have to weigh down the frequent terms.
tfidf = TfidfVectorizer(stop_words='english')  #Transforms text to feature vectors

metadata['overview'] = metadata['overview'].fillna('')

#It transforms text to numbers. and count no. of occurences 
...
#function which return 10 most similar movies based on the cosine similarity score.
...
# print(ind)
plt.title("Bar Graph of Content-Plot-Description")
plt.ylabel("Score")
